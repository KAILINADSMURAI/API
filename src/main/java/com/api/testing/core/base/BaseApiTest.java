...
public abstract class BaseApiTest extends BaseTest {
	...
	private ClientResponse doFormPost(Builder builder) {
		...
		ClientResponse response = builder.type(MediaType.APPLICATION_FORM_URLENCODED).accept(MediaType.APPLICATION_JSON)
	...
	private ClientResponse doJsonPost(Builder builder) {
		try {
			...
			ClientResponse response = builder.type(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)
