...
abstract public class BaseTest {
	...
	protected void tearDown(ITestResult tr, ITestContext context, java.lang.reflect.Method m) {
		try {
			...
			L().info("Finished " + method.getRealClass() + "." + method.getMethodName() + " with parameters: "
					+ tr.getParameters());
	...
	/**
	 * Override this method when you want some specific behavior before a
	 * specific test. This method is intended to be used by subclasses like
	 * WebdriverBaseTest.
	 */
	...
	/**
	 * Override this method when you want some specific behavior after a
	 * specific test. This method is intended to be used by subclasses like
	 * WebdriverBaseTest.
	 * 
	 * @param m
