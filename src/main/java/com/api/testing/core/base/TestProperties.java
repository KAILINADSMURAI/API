...
public class TestProperties extends Properties {
	...
	// CONSTANTS
	public static List<String> EXCLUDED_GROUPS = Arrays.asList("DEPRECATED", "KNOWNBUG", "QUARANTINE");
	...
	public TestProperties(Properties defaults) {
		...
		List<String> excludedGroupsFromParams = Arrays
				.asList(this.getProperty(prefix + "excludedGroups", defaultExcludedGroups).split("\\s*,\\s*"));
		...
		imageCheckerEnabled = Boolean
				.parseBoolean(this.getProperty(prefix + "imageCheckerEnabled", defaultImageCheckerEnabled));
		...
		webdriverProfilingEnabled = Boolean
				.parseBoolean(this.getProperty(prefix + "webdriverProfilingEnabled", defaultWebdriverProfilingEnabled));

		exitCodesEnabled = Boolean.parseBoolean(this.getProperty(prefix + "exitCodesEnabled", defaultExitCodesEnabled));
		if ((this.environment != null && this.environment.equals("CI"))
				|| (this.getProperty("APP_ENV") != null && this.getProperty("APP_ENV").equals("build"))) {
			exitCodesEnabled = true;
			this.environment = "build";
		}

		reportsFolder = StringUtils.trimToNull(this.getProperty(prefix + "reportsFolder", defaultReportsFolder));
	}
